var RollTwentyMock = RollTwentyMock || function () {
  function GameObject () {
    // let's make sure EVERY possible property is defined, even though none will have functionality
    // since we're not going to subclass this for mock purposes

    // "private" vars
    this._id = ++objectCounter
    this._type = 'undef'
    this._pageid = '4'
    this._path = '[["M", 0, 35],["C", 0, 17.5, 17.5, 0, 35, 0],["C", 52.5, 0, 70, 17.5, 70, 35],["C", 70, 52.5, 52.5, 70, 35, 70],["C", 17.5, 70, 0, 52.5, 0, 35]]'
    this._subtype = 'token'
    this._cardid = '4'
    this._zorder = ''
    this._journalfolder = '{}'
  ...
  GameObject.prototype.get = function get(attribute_name) {
    return this[attribute_name]
  }

  GameObject.prototype.set = function get(attribute_name, new_value) {
    return this[attribute_name] = new_value
  }
...
exports.getObj = RollTwentyMock.getObj
exports.findObjs = RollTwentyMock.findObjs
exports.filterObjs = RollTwentyMock.filterObjs
exports.getAllObjs = RollTwentyMock.getAllObjs
exports.state = RollTwentyMock.state
exports.Campaign = RollTwentyMock.Campaign
